...
class Ftp {
    ...
    public function checkRootPath($rootpath) {
        ...
        if (!@ftp_chdir($this->link, $this->rootPath)) {
            $this->error = '上传根目录不存在!！' . $this->rootPath;
            return false;
        }
        return true;
    }
    ...
    public function delete($filepath) {
        if (ftp_delete($this->link, $filepath)) {
            unset($filepath);
            return true;
        }
        return false;
     ...
     * @return type
     */
    public function nlist($filepath) {
        $contents = ftp_nlist($this->link, $filepath);
        if ($contents) {
            unset($filepath);
        }
        return $contents;
     ...
     * @return type
     */
    public function chdir($filepath) {
        return @ftp_chdir($this->link, $filepath);
    }
