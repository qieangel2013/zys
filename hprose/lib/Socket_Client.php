 ...
 *                                                        *
\**********************************************************/
require_once __DIR__ . '/HandlerManager.php';
require_once __DIR__ . '/InvokeSettings.php';
require_once __DIR__ . '/ResultMode.php';
require_once __DIR__ . '/BytesIO.php';
require_once __DIR__ . '/Writer.php';
require_once __DIR__ . '/Tags.php';
require_once __DIR__ . '/Reader.php';
require_once __DIR__ . '/functions.php';
abstract class Socket_Client extends HandlerManager {
    private $index = -1;
