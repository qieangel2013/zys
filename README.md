###yaf项目快速开发：
	...
	添加了全局变量适用于高并发抢购、秒杀，数组算法处理等（需要安装php扩展zqf，详情见：[https://github.com/qieangel2013/php_ext_zqf](https://github.com/qieangel2013/php_ext_zqf)）
       	首先安装php扩展zqf.so
        phpize来安装
        然后在php文件调用
	...
	$task->connect(json_encode($data));
        ...
        添加了验证码类
         ...
         $Verify->entry();
        添加了生成二维码功能（需要安装php扩展zqf，详情见：[https://github.com/qieangel2013/php_ext_zqf](https://github.com/qieangel2013/php_ext_zqf)）
       	$obj=new zqf();
